...
export function Auth({ onLoginSuccess, lang = 'ar', setLang }: AuthProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#fbfbfd] font-['Almarai',-apple-system,BlinkMacSystemFont,sans-serif]" dir={isRtl ? "rtl" : "ltr"}>
      ...
      {/* Main Content Area */}
      <div className="flex-1 flex flex-col items-center justify-center p-4 py-8 sm:py-12 w-full my-auto">
         {/* Brand logo area */}
         <div className="mb-6 flex flex-col items-center max-w-[90vw] mx-auto text-center px-4">
            ...
            <div className="flex flex-col items-center gap-1 opacity-90 transition-all hover:opacity-100">
                <div className="text-[#057a55] font-diwani text-[22px] md:text-[26px] font-normal leading-relaxed tracking-wider antialiased" dir="rtl">
         ...
         <div className="max-w-[400px] w-full bg-white/80 backdrop-blur-3xl rounded-[24px] shadow-[0_8px_40px_-12px_rgba(0,0,0,0.08)] border border-slate-200/50 p-5 sm:p-6 mb-6">
      ...
      {/* Footer text */}
      <footer className="w-full bg-white border-t border-slate-900/5 py-1 px-4 shadow-[0_-1px_3px_rgba(0,0,0,0.02)] z-40 flex justify-center items-center transition-all mt-auto shrink-0 pb-safe">
