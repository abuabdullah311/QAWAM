...
`;
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 font-['29LT_Azer',sans-serif]" dir="rtl">
            ...
            <div className="bg-slate-50 border border-slate-100 p-5 rounded-xl mb-6">
              ...
              <form onSubmit={handleCreateUser} className="flex flex-wrap items-end gap-4">
                ...
                <button
                  ...
                  className="bg-slate-800 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-slate-900 h-[38px] flex items-center min-w-[80px] justify-center"
                >
